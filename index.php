          ...
          <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
            ...
            <div class="hexagon-menu clear">
              <div class="hexagon-item">
                ...
                <a href="partials/guru/login.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
                    <span class="title">Login Guru</span>
                  </span>
              ...
              <div class="hexagon-item">
                ...
                <a href="partials/kandidat/login.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
                    <span class="title">Login kandidat</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="hexagon-item">
                ...
                <a href="partials/admin/login.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
                    <span class="title">Login Panitia</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path>
              ...
              <div class="hexagon-item">
                ...
                <a href="partials/siswa/login.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
                    <span class="title">Login Siswa</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path>
              ...
              <div class="hexagon-item">
                ...
                <a href="osis.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
                    <span class="title">Apa Itu Osis</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path>
              ...
              <div class="hexagon-item">
                ...
                <a href="author.php" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class=""></i>
                    </span>
