    ...
    <div class="pt-tablecell page-welcome relative">
        ...
        <div class="row">
          <div class="col-xs-12 col-md-6 col-lg-7">
            <div class="page-title">
              <h2>Osis<span class="primary"></span> <span class="title-bg">About</span></h2>
              <p>Organisasi Siswa Intra Sekolah adalah sebuah organisasi resmi satu-satunya di sekolah yang diakui oleh Kementerian Pendidikan Nasional Republik Indonesia sejak 21 Maret 1970. Organisasi ini memiliki peran sebagai penggerak siswa untuk aktif berkontribusi di sekolah</p>
            </div>
          </div>
        </div> <!-- /.row -->
      </div> <!-- /.container -->
      ...
      <div class="container">
        <div class="flex flex-middle space-between">
          <span class="copyright">Copyright &copy; Cahyadi Prasetyo 2022</span>
          <span class="next-page"><a href="author.php" class="link">Next Page &rarr;</a></span>
        </div>
      </div>
  <!-- /.page-nav -->
</nav>
