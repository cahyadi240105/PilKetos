...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn,"INSERT INTO guru VALUES ('$nip','$nama','$jk','$username','$password',$id_panitia)");
    if($query){
        echo"<script>
									...
									<div class="row justify-content-center">
										<div class="col-md-6 col-lg-4">
											<div class="form-group form-floating-label">
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required name="nip" autocomplete="off">
												<label for="inputFloatingLabel" class="placeholder">Nip</label>
											</div>
											<div class="form-group form-floating-label">
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required name="nama" autocomplete="off">
											...
											<div class="form-group form-floating-label">
                                                <select class="form-control input-solid" id="selectFloatingLabel2" required name="jk">
													<option value="">&nbsp;</option>
                                            ...
                                            <input id="inputFloatingLabel" type="hidden" class="form-control input-border-bottom" name="id_panitia" autocomplete="off" value="null">
										</div>
									</div>
								</div>
