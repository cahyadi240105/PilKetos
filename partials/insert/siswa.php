...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn,"INSERT INTO siswa VALUES ('$nis','$nama','$jk','$kelas','$username','$password')");
    if($query){
        echo"<script>
									...
									<div class="row justify-content-center">
										<div class="col-md-6 col-lg-6">
											<div class="form-group form-floating-label">
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required name="nis" autocomplete="off">
												<label for="inputFloatingLabel" class="placeholder">Nis</label>
											</div>
											<div class="form-group form-floating-label">
