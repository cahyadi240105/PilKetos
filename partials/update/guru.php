        ...
        <div class="main-panel">
			<div class="content">
				<div class="page-inner">
                    ...
                    <?php 
                        $nip = $_GET['nip'];
                        $data = mysqli_query($conn,"SELECT * FROM guru WHERE nip='$nip'");
									...
									<div class="row justify-content-center">
										<div class="col-md-6 col-lg-4">
											<div class="form-group form-floating-label">
												...
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required name="nip" autocomplete="off" value="<?= $d['nip'];?>" disabled>
											...
											<div class="form-group form-floating-label">
                                                <select class="form-control input-solid" id="selectFloatingLabel2" required name="jk" value="<?= $d['jk'];?>">
